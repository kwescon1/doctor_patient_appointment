...
WORKDIR /var/www/doctor_patient_appointment
...
# RUN chmod -R 775 /var/www/doctor_patient_appointment
# RUN chown -R ubuntu:www-data /var/www/doctor_patient_appointment
